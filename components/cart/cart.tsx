                            ...
                            <div className="grid grid-cols-3 items-start gap-4">
                                <div className="col-span-2 flex items-start gap-4">
                                    <div className="w-28 h-28 max-sm:w-24 max-sm:h-24 shrink-0 bg-gray-100 p-2 rounded-md">
                                        <img src='https://media.istockphoto.com/id/2149958896/photo/two-luxury-perfume-bottles-on-studio-display.webp?a=1&b=1&s=612x612&w=0&k=20&c=uNAykoTPWFcOU7j-CgRf4Jayv45xg-cozeSrhBGFXgY=' className="w-full h-full object-contain" />
                                    </div>
