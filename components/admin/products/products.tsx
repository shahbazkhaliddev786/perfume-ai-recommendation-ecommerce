    ...
    <div className="container mx-auto p-4">
      ...
      {isEditing && currentProduct && currentProduct.id === Date.now() && (
        <form onSubmit={handleAddProduct} className="mt-6">
          ...
          <button type="submit" className="text-white bg-gradient-to-r from-purple-500 to-red-500 shadow-md hover:from-purple-600 hover:to-red-600 focus:outline-none focus:ring-4 focus:ring-purple-300 p-2 rounded">
            Add Product
          </button>
          <button
            type="button"
