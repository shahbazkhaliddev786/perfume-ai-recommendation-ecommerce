            ...
            <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    ...
                    <ul className="flex mt-12 space-x-4">
                        <li className="text-white bg-gradient-to-r from-purple-500 to-red-500 shadow-md hover:from-purple-600 hover:to-red-600 focus:outline-none focus:ring-4 focus:ring-purple-300 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                ...
                <div className="bg-gray-100 p-6 rounded-lg">
                    ...
                    <form className="mt-8 space-y-4">
                        ...
                        <button type='button'
                            className="text-white bg-gradient-to-r from-purple-500 to-red-500 shadow-md hover:from-purple-600 hover:to-red-600 focus:outline-none focus:ring-4 focus:ring-purple-300 tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
